...
import 'any_page_model.dart';
export 'any_page_model.dart';

class AnyPageWidget extends StatefulWidget {
  const AnyPageWidget({super.key});

  @override
  State<AnyPageWidget> createState() => _AnyPageWidgetState();
}

class _AnyPageWidgetState extends State<AnyPageWidget> {
  late AnyPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnyPageModel());
