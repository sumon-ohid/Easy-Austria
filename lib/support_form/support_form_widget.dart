...
class _SupportFormWidgetState extends State<SupportFormWidget> {
  ...
  void initState() {
    ...
    _model.ticketBodyTextController ??= TextEditingController();
    _model.ticketBodyFocusNode ??= FocusNode();
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: Padding(
            padding: const EdgeInsetsDirectional.fromSTEB(26.0, 12.0, 26.0, 0.0),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          controller: _model.ticketBodyTextController,
                          focusNode: _model.ticketBodyFocusNode,
                          autofocus: true,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelStyle: FlutterFlowTheme.of(context)
                          ...
                          minLines: 6,
                          cursorColor: FlutterFlowTheme.of(context).primary,
                          validator: _model.ticketBodyTextControllerValidator
                              .asValidator(context),
                        ),
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await launchUrl(Uri(
                              scheme: 'mailto',
                              path: 'oahid.sumon@gmail.com',
                              query: {
                                'subject': _model.subjectTextController.text,
                                'body': _model.ticketBodyTextController.text,
                              }
                                  .entries
